...
foreach ($array as $file){
  ...
  echo "<strong>" . $file . "</strong>" . " - " . "<strong>" . $xml->hostipaddress . "</strong>" . " - last update: " . date ("F d Y H:i:s", filemtime("xml/" . $file . ".xml")) . " - " . "<strong>" . "<a href=" . $xml->hypervisor . " target=" . "_blank" . ">Dashboard</a>" . "</strong>";
